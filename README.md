...
adding, updating songs using redux store works.
adding songs to graphql server works.

TODO:
updating graphql data cache
updating song titles in graphql server store
